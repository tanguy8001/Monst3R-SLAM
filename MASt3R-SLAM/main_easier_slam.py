...
from mast3r_slam.easi3r_utils import (
    load_mast3r,
    load_easi3r,
    load_retriever,
    easi3r_inference_mono,
)
from mast3r_slam.multiprocess_utils import new_queue, try_get_msg
from mast3r_slam.tracker3 import FrameTracker3
...
def relocalization(frame, keyframes, factor_graph, retrieval_database, all_frames=None):
    ...
    with keyframes.lock:
        kf_idx = []
        # Find similar keyframes in the database
        ...
        # If there are similar keyframes, establish a relative pose between the current frame and the most similar keyframe
        if kf_idx:
        ...
        # If relocalization is successful, we solve the GN optimization to refine all poses
